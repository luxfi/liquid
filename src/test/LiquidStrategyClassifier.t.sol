...
import {LiquidStrategyClassifier} from "../LiquidStrategyClassifier.sol";

contract MockStrategyClassifier is LiquidStrategyClassifier {
    constructor(address _admin) LiquidStrategyClassifier(_admin) {}
}

contract LiquidStrategyClassifierTest is Test {
