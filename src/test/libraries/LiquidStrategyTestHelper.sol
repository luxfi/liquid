...
library LiquidStrategyTestHelper {
    ...
    function _setupStrategy(address vault, address yieldToken, address owner, string memory name, string memory protocol, ILiquidStrategy.RiskClass riskClass)
        external
        returns (MockLiquidStrategy)
    {
        ...
        return new MockLiquidStrategy(vault, yieldToken, params);
    }
}
