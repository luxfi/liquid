...
/// @title  LiquidMintableToken
/// @author Lux Liquid
///
/// @notice This is the contract for version two liquid mintable tokens.
contract LiquidMintableToken is AccessControl, ReentrancyGuard, ERC20, IERC3156FlashLender {
    ...
    /// @param state  A flag indicating if the liquid is paused or unpaused.
