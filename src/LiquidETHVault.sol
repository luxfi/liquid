...
contract LiquidETHVault is AbstractFeeVault, ReentrancyGuard {
     ...
     * @param _liquid Address of the Liquid contract
     * @param _owner Address of the owner
     */
    constructor(address _weth, address _liquid, address _owner) AbstractFeeVault(_weth, _liquid, _owner) {}
