...
contract LiquidStrategyClassifier is ILiquidStrategyClassifier {
    ...
    /**
     * @notice globalCap is the maximum allocation (within the VAULT) for ALL strategies of this risk type combined.
     * @notice localCap is the maximum allocation (within the VAULT) for a SINGLE strategy in the risk class.
     */
    struct RiskClass {
    ...
    // ===== ILiquidStrategyClassifier Interface Implementation =====
