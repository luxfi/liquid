...
/**
 * @title LiquidTokenVault
 * @notice A vault that holds a specific ERC20 token, allowing anyone to deposit
 * but only authorized parties to withdraw.
 */
contract LiquidTokenVault is AbstractFeeVault {
    /**
     * @notice Constructor initializes the token vault
     * @param _token The ERC20 token managed by this vault
     * @param _liquid The Liquid contract address that will be authorized
     * @param _owner The owner of the vault
     */
    constructor(address _token, address _liquid, address _owner) AbstractFeeVault(_token, _liquid, _owner) {}
