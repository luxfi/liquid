...
import {FixedPointMath} from "./FixedPointMathOld.sol";
...
library Stake {
    ...
    function getUpdatedTotalUnclaimed(Data storage _self, Pool.Data storage _pool, Pool.Context storage _ctx) internal view returns (uint256) {
