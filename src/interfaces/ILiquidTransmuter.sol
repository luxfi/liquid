...
interface ILiquidTransmuter {
    ...
    /// @notice Gets the address of the liquid.
    ///
    /// @return liquid The liquid address.
    function liquid() external view returns (ILiquid liquid);
    ...
    /// @notice Returns array of liquids.
    function liquids(uint256) external view returns (address liquid);
    ...
    /// @notice Set a new liquid for redemptions.
    ///
    /// @param liquid The address of the new liquid.
    function setLiquid(address liquid) external;
    ...
    /// @notice Emitted when the associated liquid is updated.
    ///
    /// @param liquid The address of the new liquid.
    event LiquidUpdated(address liquid);
