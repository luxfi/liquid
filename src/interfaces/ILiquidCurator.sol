...
interface ILiquidCurator {
    ...
    event StrategySet(address indexed strategy, address indexed vault);
    event SubmitSetStrategy(address indexed strategy, address indexed vault);
}
