...
/**
 * @title ILiquidTokenVault
 * @notice Interface for the LiquidTokenVault contract
 */
interface ILiquidTokenVault {
    ...
    /**
     * @notice Get the address of the Liquid contract
     * @return The Liquid contract address
     */
    ...
    /**
     * @notice Allows only the Liquid or authorized withdrawers to withdraw tokens
    ...
    /**
     * @notice Updates the Liquid address
     * @param _liquid The new Liquid address
     */
    function setLiquid(address _liquid) external;
    ...
    /**
     * @notice Emitted when the Liquid address is updated
     */
