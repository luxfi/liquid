...
/**
 * @title ILiquidPosition
 * @notice Interface for the LiquidPosition ERC721 token.
 */
interface ILiquidPosition is IERC721Enumerable {
    /**
    ...
    /**
     * @notice Returns the address of the Liquid contract which is allowed to mint and burn tokens.
     */
